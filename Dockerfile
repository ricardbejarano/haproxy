...
RUN apk add \
      ca-certificates
WORKDIR /tmp/haproxy
ADD --checksum=sha256:be64ed565c320e670bb909c5834f90303c3ec0c97af5befa45994961aaa6c6ec https://www.haproxy.org/download/3.2/src/haproxy-3.2.2.tar.gz /tmp/haproxy.tar.gz

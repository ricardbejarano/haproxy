...
RUN apk add \
      ca-certificates
WORKDIR /tmp/haproxy
ADD --checksum=sha256:bb3f967a797c8851d08683ec43dfafe4ad7bf5ad86fa6b0721cad033ea9e5ae5 https://www.haproxy.org/download/3.2/src/haproxy-3.2.1.tar.gz /tmp/haproxy.tar.gz

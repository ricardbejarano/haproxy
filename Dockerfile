...
RUN apk add \
      ca-certificates
WORKDIR /tmp/haproxy
ADD --checksum=sha256:af8ef64286bdddc93232c5dbe4ea436a8ccb5dc8417cfa1e885bec52884f9347 https://www.haproxy.org/download/3.2/src/haproxy-3.2.3.tar.gz /tmp/haproxy.tar.gz

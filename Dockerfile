...
RUN apk add \
      ca-certificates
WORKDIR /tmp/haproxy
ADD --checksum=sha256:f762ae31bca1b51feb89e4395e36e17f867c25372a10853c70d292c3dd17b7b0 https://www.haproxy.org/download/3.2/src/haproxy-3.2.0.tar.gz /tmp/haproxy.tar.gz

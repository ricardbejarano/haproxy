...
RUN apk add \
      ca-certificates
WORKDIR /tmp/haproxy
ADD --checksum=sha256:7fa666d36d198275999e2a68dda44d3d37960f2f7aed3a595fb811f4fd0515b5 https://www.haproxy.org/download/3.4/src/haproxy-3.4.3.tar.gz /tmp/haproxy.tar.gz

...
RUN apk add \
      ca-certificates
WORKDIR /tmp/haproxy
ADD --checksum=sha256:2e62c4ce4fd77d3bc7cf17e586431663454456a078b7c8465b8f0125b5bc22f8 https://www.haproxy.org/download/3.4/src/haproxy-3.4.1.tar.gz /tmp/haproxy.tar.gz

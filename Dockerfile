...
RUN apk add \
      ca-certificates
WORKDIR /tmp/haproxy
ADD --checksum=sha256:ad630b6b0b73e1d118acce458fec1bf1e7d0e429530f2668ec582f4f8bb78e65 https://www.haproxy.org/download/3.2/src/haproxy-3.2.6.tar.gz /tmp/haproxy.tar.gz

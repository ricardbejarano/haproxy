...
RUN apk add \
      ca-certificates
WORKDIR /tmp/haproxy
ADD --checksum=sha256:f31e8e68db077cc0956f4ed3ff7a1ec637aa5e348c6d1c5cd2163e7afeb1b9e6 https://www.haproxy.org/download/3.3/src/haproxy-3.3.9.tar.gz /tmp/haproxy.tar.gz
